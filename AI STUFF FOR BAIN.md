...
draws a straight line between x and y(price of a house based on its size, as price increases, size increases too)
2.Logistic Regression: used for classification(binary) (fraud detection, medical diagnosis)
calculates the probability of a situation occurring or not occurring(yes or no)
